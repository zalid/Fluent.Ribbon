...
namespace Fluent
{
	...
	public class RibbonLocalization : INotifyPropertyChanged
	{
		...
		private void LoadCulture(CultureInfo culture)
		{
			...
			switch(language)
			{
				...
				case "zh":
					...
					{// zh-CN
						this.LoadSimplifiedChinese();
					}
					else
					{// zh-TW, zh-HK
						this.LoadTraditionalChinese();
					}
					break;
		...
		#region Chinese
		private void LoadTraditionalChinese()
		{
			// Backstage button text & key tip
			...
			// See right-top corner... (two different tooltips must be if you press it)
			this.minimizeButtonScreenTipTitle = "最小化功能區 (Ctrl + F1)";
			this.minimizeButtonScreenTipText = "僅顯示功能區的索引標籤。點選索引標籤可顯示命令。";
			this.expandButtonScreenTipTitle = "展開功能區 (Ctrl + F1)";
			this.expandButtonScreenTipText = "永遠顯示功能區的索引標籤和命令。";
			...
			// Click on Ribbon to show context menu
			this.ribbonContextMenuAddItem = "新增至快速存取工具列"; // Button
			this.ribbonContextMenuAddGroup = "新增群組至快速存取工具列"; // For ex., by collapsed group
			this.ribbonContextMenuAddGallery = "新增圖庫至快速存取工具列"; // For ex., by opened font context menu
			this.ribbonContextMenuAddMenu = "新增選單至快速存取工具列"; // By dashed splitter in context menu
			this.ribbonContextMenuRemoveItem = "從快速存取工具列中移除"; // By item in QAT
			this.ribbonContextMenuCustomizeQuickAccessToolbar = "自訂快速存取工具列...";
			this.ribbonContextMenuShowBelow = "在功能區下方顯示快速存取工具列";
			this.ribbonContextMenuShowAbove = "在功能區上方顯示快速存取工具列";
			this.ribbonContextMenuCustomizeRibbon = "自訂功能區...";
			this.ribbonContextMenuMinimizeRibbon = "最小化功能區";

			// To see it in Word: open *.doc (not *.docx) and see Insert->Screenshot
			// (This prop was introduced after v1.3) 
			this.screenTipDisableReasonHeader = "目前已禁用此命令";
			this.screenTipF1LabelHeader = "按 F1 取得說明";

			// Right-click on status bar to see it. NEW! from v2.0
			this.customizeStatusBar = "自訂狀態列";
		}


		private void LoadSimplifiedChinese()
		{
			// Backstage button text & key tip
			...
			this.screenTipF1LabelHeader = "按 F1 取得帮助";
